...
<body>
	...
	<div class="wrapper">
		...
		<ul class="list-unstyled components">
			<li align="center">
				<img src="avatar5.png"><h4>Merchant</h4></li>
			...
			<li><a href="#homeSubmenu" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="homeSubmenu">
					...
					<li><a href="merchant_delete_product">Delete Product</a>
					</li>
					<li><a href="merchant_update_product">Update Product</a>
					</li>
					<li><a href="merchant_display_products">Display
							Products</a></li>
				</ul></li>
			<li><a href="merchant_check_order_details">Check Order
					Details</a></li>
