...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form action="admin_add_merchant" onsubmit="success()" method ="POST">       
     <div class="container">
	 <h1>Add Merchant</h1><br />
	 Enter Merchant details to add
	 <hr>
	 <table>
	  
	 <tr>
	 <td>Merchant Name  </td> 
	 <td><input type="text"  name="merchantName" required placeholder="Enter Merchant Name" /></td>
	</tr>
	  <tr>
	  <td>Merchant Mobile Number</td>
	   <td><input type="text"  name="mobileNo"  placeholder="Enter Mobile Number" required/></td>
       </tr>
	   <tr>
      <td>Merchant Email</td>
      <td><input type="text"  name="merchantEmail" placeholder="Enter Email id" required /></td>
       </tr>
	   <tr>
   <td>Merchant Address </td>
    <td><input type="text"  name="merchantAddress"  placeholder="Enter merchant Address" required="" autofocus="" /></td>
    </tr>
