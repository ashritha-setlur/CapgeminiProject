...
<head>
    ...
    <!-- Title  -->
    <title>CapStore | Merchant Registration</title>
...
<div class="checkout_area section-padding-80">
		...
		<div><br></div>
            <div class="row">
				<div class="col-md-6">
			<form name="merch_register" class="form-horizontal" action="#" onsubmit="return checkForm(this);" method="GET">
              <div class="box-body">
			  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="mobileNo" pattern="/^[0]?[789]\d{9}$/" placeholder="Enter Your Mobile Number" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="password1" class="col-sm-6 control-label">Password</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="password1" name="password1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter Your Password" required>
                  </div>
                </div>
				 <div class="form-group">
